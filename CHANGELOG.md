...
- Fix list markers inside labeled-item procedure lists overflowing Snap Lab borders in `hs-physics`: add `SnapLabLabeledItemLists` targeting `ul[data-labeled-item="true"] li` context
...
- Use `first-of-group` instead of `first` (PrinceXML 16 breaking change)
...
- Add link styling to notes in `corn` (color: #0270A1)
...
- Add placeholder style for `super`

## [v2.12.2] - 2025-08-27

- Unset `max-height` for `NoClassNote` and `SelfCheck` in `algebra-1`
